 ...
 *
 * @FieldWidget(
 *   id = "display_only_string",
 *   label = @Translation("Display Only"),
 *   field_types = {
 *     "string"
 *   },
 * )
 */
class DisplayOnly extends StringTextfieldWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    // ksm($element, $items, $this->fieldDefinition);

    $label = $this->fieldDefinition->getLabel();

    $element = [
      '#markup' => $label . " " . $items[$delta]->value,
    ];
